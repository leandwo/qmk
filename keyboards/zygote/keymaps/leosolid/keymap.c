...
KC_ESC,HYPR(KC_F18),MEH(KC_F19),KC_BSPC,LT(1, KC_SPC),LT(2,KC_TAB),OSL(3), LT(4, KC_ENT),OSM(MOD_RSFT),KC__VOLDOWN,KC__VOLUP,TG(5) \
),
...
_______,_______,_______,_______,_______,_______,_______,_______,_______,KC_K,_______,_______, \
_______,_______,_______,_______,_______,_______,_______,_______,KC_H,KC_J,KC_L,_______ \
),
...
KC_QUOTE,KC_LCBR,KC_LBRC,KC_LPRN,KC_MINUS,KC_UNDERSCORE,KC_PLUS,KC_EQUAL,KC_RPRN,KC_RBRC,KC_RCBR,KC_DOUBLE_QUOTE, \
...
_______,_______,_______,_______,_______,_______,_______,KC_MPLY,KC_MPRV,KC_MNXT,KC__VOLUP,KC__VOLDOWN, \
...
TO(0),_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,TO(6) \
),
...
TO(5),_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,KC_NO \
)
